  ...
  const fetchLeaderboard = async () => {
    try {
      ...
      const response = await fetch(
        `${API_URL}/api/leaderboard?level=${selectedLevel}`,
        {
    ...
    <div className="leaderboard-page">
          ...
          <div className="rankings-table">
            ...
            <div className="table-body">
              {leaderboardData.map((player) => (
                <div
                  key={player.rank}
                  className={`table-row ${player.finalist ? "finalist-row" : ""}`}
                >
                  ...
                  <div className="cell status-col">
                    {player.finalist && (
                      <span className="finalist-tag">Finalist</span>
                    )}
                  </div>
                </div>
              ))}
      ...
      <div className="info-section">
        <div className="info-card">
          ...
          <p>
            Every bi-weekly cycle, the top 10 players in each level receive
            rewards. Once rewarded, they cannot re-enter the top 10 for that
            specific level.
          </p>
        </div>
        ...
        <div className="info-card">
          ...
          <p>
            The top 5 from each of the 6 levels (30 unique players) become
            finalists. If you qualify in multiple levels, you're assigned to
            your highest level.
          </p>
        </div>
      </div>
