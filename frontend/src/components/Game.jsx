  ...
  useEffect(() => {
    ...
    class MainScene extends Phaser.Scene {
      ...
      checkCollisions() {
        ...
        // Check coins - OPTIMIZED: No database calls during gameplay!
        this.coins.children.entries.forEach((coin) => {
          ...
          if (coinLane === playerLane && Math.abs(coinY - playerY) < 55) {
            ...
            // Update local score (NO DATABASE CALL)
            this.coins++;
            this.score += 10;
      ...
      hitObstacle() {
        ...
        // NOW save to database (only once at end)
        this.showGameOver();
      }
      ...
      async showGameOver() {
        ...
        // Save to database ONCE at the end
      ...
      update(time, delta) {
        ...
        // Check collisions (optimized - no DB calls)
