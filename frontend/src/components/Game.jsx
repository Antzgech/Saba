      ...
      startGame() {
        ...
        this.levelTimer = this.time.addEvent({
          ...
          callback: () => {
            ...
            console.log(`🎚️ Level up! Now Level ${this.level}, Speed: ${this.currentSpeed}`);
      ...
      checkCollisions() {
        ...
        this.coins.children.entries.forEach((coin) => {
          ...
          if (coinLane === playerLane && Math.abs(coinY - playerY) < 55) {
            ...
            console.log(`💰 Coin collected! Score: ${this.score}, Coins: ${this.coins}`);
          }
        });
      }
